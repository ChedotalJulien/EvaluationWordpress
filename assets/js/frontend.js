...
function likedislike(after_load = '') {
    jQuery(document).ready(function ($) {
        ...
        $(click_val).click(function () {
            var ajaxurl = pluginsimplon_frontend_script.ajax_url;
            ...
            var data = {
                'action': 'pluginsimplon_like_dislike',
                'postID': postID,
                'LikeDislike': LikeDislike,
                '_wpnonce': pluginsimplon_frontend_script.ajax_nonce,
            };
...
pluginsimplon_post_reaction();
function pluginsimplon_post_reaction(after_load_reaction = '') {
    jQuery(document).ready(function ($) {
        "use scrict";
        ...
        $(click_val).click(function () {
            ...
            var data = {
                'action': 'pluginsimplon_post_react',
                'postID': postID,
                'reactdata': reactdata,
                '_wpnonce': pluginsimplon_frontend_script.ajax_nonce,
            };
