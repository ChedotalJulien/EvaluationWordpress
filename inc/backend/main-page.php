        ...
        <div class="twp-content-primary">
            ...
            <div class="main-wraper-options main-wraper-options-2 twp-block-panel">
                <form class="acft-plugin-settings-form" method="post" action="<?php echo esc_url( admin_url() . 'admin-post.php' )?>">
                    <input type="hidden" name="action" value="pluginsimplon_settings_options" />
                    ...
                    <div class="twp-form-content">
                        <div id="twp-be-social-share-content" class="twp-be-content twp-content-active">
                            <div class="twp-be-options">
                                                ...
                                                <?php if( $key == 'email' ){ ?>
                                                    <div style="display: none;" class="twp-social-control" id="twp-social-control-email">
                                                        ...
                                                        <div class="twp-opt-wrap twp-opt-wrap-alt">
                                                            ...
                                                            <input type="text" name="social_share_email_subject" value="<?php echo esc_html( $twp_be_settings[ 'social_share_email_subject' ] ); ?>" />
                                                            
                                                        </div>
                                                        <div class="twp-opt-wrap twp-opt-wrap-alt">
                                                            <label><?php esc_html_e('Email Body','booster-extension') ?></label>
                                                            <textarea name="social_share_email_body" rows="10" cols="100"><?php echo  esc_html( $twp_be_settings[ 'social_share_email_body' ] ) ; ?></textarea>
                                                ...
                                                <?php if( $key == 'facebook' ){ ?>
                                                    <div style="display: none;" class="twp-social-control" id="twp-social-control-facebook">
                                                        <div class="twp-opt-wrap twp-opt-wrap-alt">
                                                            ...
                                                            <input type="text" name="social_share_fb_app_id" value="<?php echo esc_html( $twp_be_settings[ 'social_share_fb_app_id' ] ); ?>" />
                                                            
                                                        </div>
                                                        <div class="twp-opt-wrap twp-opt-wrap-alt">
                                                            <label><?php esc_html_e('App Secret Key','booster-extension') ?></label>
                                                            <input type="text" name="social_share_fb_secret_key" value="<?php echo esc_html( $twp_be_settings[ 'social_share_fb_secret_key' ] ); ?>" />
                                ...
                                <?php $twp_be_settings[ 'social_share' ]; ?>
                            ...
                            <div class="twp-be-options">
                                <h2 class="booster-control-title">
                                    <span class="booster-icons dashicons dashicons-admin-settings"></span> <?php esc_html_e('Display Settings','booster-extension'); ?>
                                </h2>
                                <div class="twp-be-option-settings">
                                    ...
                                    <div class="twp-opt-wrap twp-opt-wrap-alt">
                                        ...
                                        <input type="text" name="social_share_title" value="<?php echo esc_html( $twp_be_settings[ 'social_share_title' ] ); ?>" />
                                        
                                    </div>
                                    <div class="twp-opt-wrap">
                                       
                                         <input type="checkbox" name="social_share_ed_post" <?php if( !empty( $twp_be_settings[ 'social_share_ed_post' ] ) ){ ?> checked="checked" <?php } ?> />
                                         <label><?php esc_html_e('Show On Single Post','booster-extension') ?></label>
                                    </div>
                                    <div class="twp-opt-wrap">
                                        
                                        <input type="checkbox" name="social_share_ed_archive" <?php if( !empty( $twp_be_settings[ 'social_share_ed_archive' ] ) ){ ?> checked="checked" <?php } ?> />
                                        <label><?php esc_html_e('Show On Archive Page','booster-extension') ?></label>
                                    </div>
                                    <?php $twp_be_open_link_type = $twp_be_settings[ 'twp_be_open_link_type' ]; ?>
                                    <div class="twp-opt-wrap twp-opt-wrap-alt">
                                    ...
                                    <div class="twp-opt-wrap">
                                        ...
                                        <input type="checkbox" name="social_share_ed_socila_counter" <?php if( !empty( $twp_be_settings[ 'social_share_ed_socila_counter' ] ) ){ ?> checked="checked" <?php } ?> />
                            ...
                            <div class="twp-be-options">
                                <h2 class="booster-control-title booster-control-title-alt">
                                    <span class="booster-icons dashicons dashicons-lightbulb"></span> <?php esc_html_e('How To Use','booster-extension'); ?>
                                </h2>
                                <div class="twp-be-option-settings">
                                    <div class="twp-opt-wrap twp-opt-wrap-info">
                                        <label>
                                            ...
                                            <code>
                                                ...
                                                <br>do_action('pluginsimplon_social_icons',$args);
                                            </code>
                                            ...
                                            <code>pluginsimplon_filter_ss_ed</code>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="twp-be-options">
                                ...
                                <div class="twp-be-option-settings">
                                    <div class="twp-opt-wrap twp-opt-wrap-alt twp-opt-switch">
                                        ...
                                        <input id="booster-authorbox-checkbox" type="checkbox" name="twp_be_show_author_box" <?php if( !empty( $twp_be_settings[ 'twp_be_show_author_box' ] ) ){ ?> checked="checked" <?php } ?> />
                                    ...
                                    <div class="twp-opt-wrap twp-opt-wrap-alt">
                                        ...
                                        <input type="text" name="twp_be_show_author_title" value="<?php echo esc_html( $twp_be_settings['twp_be_show_author_title'] ); ?>"  />
                                        
                                    </div>
                                    <?php $twp_be_show_author_alignmrnt = $twp_be_settings[ 'twp_be_show_author_alignmrnt' ]; ?>
                                    <div class="twp-opt-wrap twp-opt-wrap-alt">
                                    ...
                                    <?php $twp_be_show_author_image_layout = $twp_be_settings[ 'twp_be_show_author_image_layout' ]; ?>
                                    <div class="twp-opt-wrap twp-opt-wrap-alt">
                                    ...
                                    <div class="twp-opt-wrap">
                                        <input type="checkbox" name="twp_be_show_author_email" <?php if( !empty( $twp_be_settings[ 'twp_be_show_author_email' ] ) ){ ?> checked="checked" <?php } ?> />
                                        <label><?php esc_html_e('Show Author Email','booster-extension') ?></label>
                                        
                                    </div>
                                    <div class="twp-opt-wrap">
                                        <input type="checkbox" name="twp_be_show_author_url" <?php if( !empty( $twp_be_settings[ 'twp_be_show_author_url' ] ) ){ ?> checked="checked" <?php } ?> />
                                        <label><?php esc_html_e('Show Author URL','booster-extension') ?></label>
                                        
                                    </div>
                                    <div class="twp-opt-wrap">
                                        <input type="checkbox" name="twp_be_show_author_role" <?php if( !empty( $twp_be_settings[ 'twp_be_show_author_role' ] ) ){ ?> checked="checked" <?php } ?> />
                                ...
                                <div class="twp-be-option-settings">
                                    <div class="twp-opt-wrap twp-opt-wrap-info">
                                        <label>
                                            ...
                                            <code>do_action('pluginsimplon_author_box');</code>
                            ...
                            <div class="twp-be-options">
                                ...
                                <div class="twp-be-option-settings">
                                        <div class="twp-opt-wrap twp-opt-wrap-alt twp-opt-switch">
                                            ...
                                            <input type="checkbox" id="booster-like-checkbox" name="twp_be_enable_like_dislike_button" <?php if( !empty( $twp_be_settings[ 'twp_be_enable_like_dislike_button' ] ) ){ ?> checked="checked" <?php } ?> />
                                            <label for="booster-like-checkbox" class="twp-checkbox-label"></label>
                                        </div>
                                        <div class="twp-opt-wrap">
                                            <input type="checkbox" name="twp_be_show_like_dislike_on_single_post" <?php if( !empty( $twp_be_settings[ 'twp_be_show_like_dislike_on_single_post' ] ) ){ ?> checked="checked" <?php } ?> />
                                            <label><?php esc_html_e('Show Like/Dislike On Single Post','booster-extension') ?></label>
                                        </div>
                                        <div class="twp-opt-wrap">
                                            <input type="checkbox" name="twp_be_show_like_dislike_on_archive" <?php if( !empty( $twp_be_settings[ 'twp_be_show_like_dislike_on_archive' ] ) ){ ?> checked="checked" <?php } ?> />
                            ...
                            <div class="twp-be-options">
                                ...
                                <div class="twp-be-option-settings">
                                    ...
                                    <div class="twp-opt-wrap twp-opt-wrap-alt twp-opt-switch">
                                        ...
                                        <input id="booster-readtime-checkbox" type="checkbox" name="twp_be_enable_read_time" <?php if( !empty( $twp_be_settings[ 'twp_be_enable_read_time' ] ) ){ ?> checked="checked" <?php } ?> />
                                    ...
                                    <div class="twp-opt-wrap twp-opt-wrap-alt">
                                        ...
                                        <input type="text" name="twp_be_readtime_word_per_minute" value="<?php echo absint( $twp_be_settings['twp_be_readtime_word_per_minute'] ); ?>"  />
                                    </div>
                            ...
                            <div class="twp-be-options">
                                ...
                                <div class="twp-be-option-settings">
                                    ...
                                    <div class="twp-opt-wrap twp-opt-wrap-alt twp-opt-switch">
                                        ...
                                        <input id="booster-reaction-checkbox" type="checkbox" name="twp_be_enable_post_reaction" <?php if( !empty( $twp_be_settings[ 'twp_be_enable_post_reaction' ] ) ){ ?> checked="checked" <?php } ?> />
                                ...
                                <div class="twp-be-option-settings">
                                    <div class="twp-opt-wrap twp-opt-wrap-info">
                                        <label>
                                            ...
                                            <h4><?php esc_html_e("Hook",'booster-extension'); ?></h4>
                                            <code>
                                                pluginsimplon_post_view_action
                                            </code>
                                            <h4><?php esc_html_e("Filter",'booster-extension'); ?></h4>
                                            <code>
                                                pluginsimplon_filter_views_ed
                                            </code>
                                        </label>
