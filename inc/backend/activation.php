...
$twp_be_settings[ 'social_share' ]  = array( 'facebook' => 1, 'twitter' => 1, 'pinterest' => 1, 'linkedin' => 1,'email' => 0 ) ;
...
$twp_be_settings[ 'twp_be_views_label' ]  = esc_html__('Page Visited:','booster-extension');
