...
add_action('wp_ajax_pluginsimplon_post_react', 'pluginsimplon_post_react_callback');
add_action('wp_ajax_nopriv_pluginsimplon_post_react', 'pluginsimplon_post_react_callback');

if( ! function_exists( 'pluginsimplon_post_react_callback' ) ) :

    // Recommendec Post Ajax Call Function.
    function pluginsimplon_post_react_callback() {
        ...
        if ( isset($_POST[ '_wpnonce' ]) && wp_verify_nonce($_POST[ '_wpnonce' ], 'be_ajax_nonce') ) {
            ...
            if( $action_type == 'be-react-1' ){
                if( pluginsimplon_can_act( $post_ID,$action_type ) ){
                    ...
                    if( !pluginsimplon_can_act( $post_ID,'be-react-3' ) ){
                        if( $react_3_ips ){
                            $react_3     = $react_3 - 1;
                            $current_ip = pluginsimplon_get_ip_address();
                    ...
                    if( !pluginsimplon_can_act( $post_ID,'be-react-4' ) ){
                        if( $react_4_ips ){
                            $react_4     = $react_4 - 1;
                            $current_ip = pluginsimplon_get_ip_address();
                    ...
                    if( !pluginsimplon_can_act( $post_ID,'be-react-5' ) ){
                        if( $react_5_ips ){
                            $react_5     = $react_5 - 1;
                            $current_ip = pluginsimplon_get_ip_address();
                    ...
                    if( !pluginsimplon_can_act( $post_ID,'be-react-6' ) ){
                        if( $react_6_ips ){
                            $react_6     = $react_6 - 1;
                            $current_ip = pluginsimplon_get_ip_address();
                ...
                if( pluginsimplon_can_act( $post_ID,$action_type ) ){
                    $react_2  = $react_2 + 1;
                    $react_2_ip_lists[] = pluginsimplon_get_ip_address();
                    
                    update_post_meta( $post_ID, 'twp_be_react_2', $react_2 );
                    update_post_meta( $post_ID, 'twp_be_ip_address_react_2', $react_2_ip_lists );
                    if( !pluginsimplon_can_act( $post_ID,'be-react-1' ) ){
                        if( $react_1_ips ){
                            $react_1     = $react_1 - 1;
                            $current_ip = pluginsimplon_get_ip_address();
                ...
                if( pluginsimplon_can_act( $post_ID,$action_type ) ){
                    $react_3  = $react_3 + 1;
                    $react_3_ip_lists[] = pluginsimplon_get_ip_address();
                ...
                if( pluginsimplon_can_act( $post_ID,$action_type ) ){
                    $react_4  = $react_4 + 1;
                    $react_4_ip_lists[] = pluginsimplon_get_ip_address();
                ...
                if( pluginsimplon_can_act( $post_ID,$action_type ) ){
                    $react_5  = $react_5 + 1;
                    $react_5_ip_lists[] = pluginsimplon_get_ip_address();
                ...
                if( pluginsimplon_can_act( $post_ID,$action_type ) ){
                    $react_6  = $react_6 + 1;
                    $react_6_ip_lists[] = pluginsimplon_get_ip_address();
