...
if (!function_exists('booster_extionsion_bp_author_widgets')) :
    ...
    {
        // Auther widget.
        register_widget('pluginsimplon_Author_widget');
    }
endif;
add_action('widgets_init', 'booster_extionsion_bp_author_widgets');
/*Video widget*/
if (!class_exists('pluginsimplon_Author_widget')) :
    /**
     * Author widget Class.
     *
     * @since 1.0.0
     */
    class pluginsimplon_Author_widget extends pluginsimplon_Widget_Base
    {
        /**
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'author_box_alignment' => array(
                    'label' => esc_html__('Alignment:', 'booster-extension'),
                    'type' => 'select',
                    'default' => 'left',
                    'options' => array(
                        'left' => esc_html__('Left', 'booster-extension'),
                        'right' => esc_html__('Right', 'booster-extension'),
                        'center' => esc_html__('Center', 'booster-extension'),
                    ),
                ),
        ...
        function widget($args, $instance)
        {
            ...
            $author_box_alignment = esc_html($params['author_box_alignment']);
