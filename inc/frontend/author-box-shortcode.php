...
*/
if( ! function_exists( 'pluginsimplon_authorbox_shortcode_display' ) ):
    function pluginsimplon_authorbox_shortcode_display($userid){
...
pluginsimplon_authorbox_shortcode_display($userid); ?>
